...
const MOCK_QUEUE: QueuePost[] = [
  ...
  { id: "q12", thumbnail: "", caption: "POV: You mass a typo in a work email and hit send before noticing", page: { name: "Laugh Central", avatar: "LC", color: "#8B5CF6" }, platforms: ["fb", "ig", "th"], scheduledAt: "Tomorrow, 7:30 AM",  scheduledDate: "Mar 28, 2026", type: "reel", status: "scheduled", comments: [] },
  { id: "q13", thumbnail: "", caption: "3 signs your body is telling you to drink more water — most people ignore #2", page: { name: "Daily Health Tips", avatar: "DH", color: "#6366F1" }, platforms: ["fb"], scheduledAt: "Tomorrow, 9:00 AM",  scheduledDate: "Mar 28, 2026", type: "photo", status: "scheduled", comments: ["Sign 1: Dark yellow urine means you're already dehydrated", "Sign 2: Persistent headaches with no other cause", "Sign 3: Dry skin that doesn't respond to moisturizer"] },
  { id: "q14", thumbnail: "", caption: "The $5 coffee habit is NOT why you're broke. Here's what actually matters.", page: { name: "Money Matters", avatar: "MM", color: "#F59E0B" }, platforms: ["fb", "ig"], scheduledAt: "Tomorrow, 10:30 AM", scheduledDate: "Mar 28, 2026", type: "photo", status: "failed",    comments: [] },
  { id: "q15", thumbnail: "", caption: "This free tool replaces 5 paid apps — and nobody is talking about it", page: { name: "TechByte", avatar: "TB", color: "#14B8A6" }, platforms: ["fb", "ig"], scheduledAt: "Tomorrow, 12:00 PM", scheduledDate: "Mar 28, 2026", type: "reel", status: "scheduled", comments: ["App 1: Notion replaces Trello + Google Docs ($30/mo saved)", "App 2: Figma replaces Sketch + InVision ($50/mo saved)"] },
  { id: "q16", thumbnail: "", caption: "The only 3 supplements actually backed by science — everything else is marketing", page: { name: "Fitness Factory", avatar: "FF", color: "#EC4899" }, platforms: ["fb", "ig"], scheduledAt: "Tomorrow, 1:30 PM",  scheduledDate: "Mar 28, 2026", type: "photo", status: "scheduled", comments: [] },
  ...
  { id: "q22", thumbnail: "", caption: "The gym at 5am vs the gym at 5pm — which one actually gets better results?", page: { name: "Fitness Factory", avatar: "FF", color: "#EC4899" }, platforms: ["fb"], scheduledAt: "Mar 29, 10:30 AM", scheduledDate: "Mar 29, 2026", type: "reel", status: "scheduled", comments: ["Morning: cortisol is highest, fat burning is elevated", "Evening: body temperature is optimal, strength peaks 3-6pm"] },
  { id: "q23", thumbnail: "", caption: "ChatGPT is not replacing programmers — it's replacing bad programmers", page: { name: "TechByte", avatar: "TB", color: "#14B8A6" }, platforms: ["fb", "ig", "th"], scheduledAt: "Mar 29, 12:00 PM", scheduledDate: "Mar 29, 2026", type: "photo", status: "scheduled", comments: [] },
  { id: "q24", thumbnail: "", caption: "The Silk Road wasn't one road. It was a network of 40+ routes connecting 3 continents.", page: { name: "History Uncovered", avatar: "HU", color: "#FF6B2B" }, platforms: ["fb", "ig"], scheduledAt: "Mar 29, 1:30 PM",  scheduledDate: "Mar 29, 2026", type: "photo", status: "scheduled", comments: ["Route 1: The Northern Steppe Route through Central Asia", "Route 2: The Maritime Silk Road through the Indian Ocean"] },
  ...
  { id: "q30", thumbnail: "", caption: "The productivity hack nobody wants to hear: stop multitasking entirely", page: { name: "Daily Health Tips", avatar: "DH", color: "#6366F1" }, platforms: ["fb"], scheduledAt: "Mar 30, 10:00 AM", scheduledDate: "Mar 30, 2026", type: "photo", status: "scheduled", comments: [] },
  { id: "q31", thumbnail: "", caption: "Vision Pro 2 rumors: everything we know so far", page: { name: "TechByte", avatar: "TB", color: "#14B8A6" }, platforms: ["fb", "ig"], scheduledAt: "Mar 30, 12:00 PM", scheduledDate: "Mar 30, 2026", type: "reel", status: "scheduled", comments: ["Leak 1: Lighter form factor — 200g vs current 600g", "Leak 2: Standalone mode without Mac tethering"] },
  { id: "q32", thumbnail: "", caption: "I tried waking up at 4:30am for 30 days. Here's what happened (honest).", page: { name: "Fitness Factory", avatar: "FF", color: "#EC4899" }, platforms: ["fb", "ig"], scheduledAt: "Mar 30, 2:00 PM",  scheduledDate: "Mar 30, 2026", type: "reel", status: "scheduled", comments: [] },
  { id: "q33", thumbnail: "", caption: "The most expensive financial mistake people make in their 30s (that nobody talks about)", page: { name: "Money Matters", avatar: "MM", color: "#F59E0B" }, platforms: ["fb", "ig"], scheduledAt: "Mar 30, 4:00 PM",  scheduledDate: "Mar 30, 2026", type: "photo", status: "scheduled", comments: [] },
  { id: "q34", thumbnail: "", caption: "POV: Your manager says 'this should only take 5 minutes'", page: { name: "Laugh Central", avatar: "LC", color: "#8B5CF6" }, platforms: ["fb", "ig", "th"], scheduledAt: "Mar 30, 6:00 PM",  scheduledDate: "Mar 30, 2026", type: "reel", status: "scheduled", comments: [] },
];
